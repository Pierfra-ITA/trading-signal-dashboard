...
# CONFIG
st.set_page_config(page_title="Trading Signal App v6.4", layout="wide")
st.title("📈 Trading Signal App – Version 6.4 (Aligned Manual DMI Fix)")
...
def calculate_adx(df, window=14):
    ...
    adx = adx.reindex(df.index)  # align index explicitly
    return adx
