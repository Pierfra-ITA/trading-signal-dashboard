...
# CONFIG
st.set_page_config(page_title="Trading Signal App v6.2", layout="wide")
st.title("📈 Trading Signal App – Version 6.2 (Final Fixes Applied)")
...
def calculate_indicators(df):
    # Ensure all inputs are 1D float Series
    close = df['Close']
